    ...
    public class CombinedForceProjectorBuild extends ForceBuild {
        ...
        public void rebuildCombo() {
            ...
            for (Building b : ComboReflect.linkedReachable(this,
                    o -> o instanceof CombinedForceProjectorBuild other && other.team == team && other.isValid(),
                    (cur, o) -> true)) {
                if (b != this)
                    comboGroup.add((CombinedForceProjectorBuild) b);
            }
        ...
        public void splitAssets(Seq<CombinedForceProjectorBuild> oldGroup, Seq<CombinedForceProjectorBuild> newGroup) {
            ...
            CombinedForceProjectorBuild newLeader = null;
            for (CombinedForceProjectorBuild b : newGroup)
            ...
            CombinedForceProjectorBuild oldLeader = newLeader;
