...
public class CombinedRegenProjector extends RegenProjector {
    ...
    public class CombinedRegenProjectorBuild extends RegenProjectorBuild implements combine.saves.ComboSaved {
        ...
        public void rebuildCombo() {
            ...
            for (Building b : ComboReflect.linkedReachable(this,
                    o -> o instanceof CombinedRegenProjectorBuild other && other.team == team && other.isValid(),
                    (cur, o) -> cur.block == o.block
                    || ((CombinedRegenProjector) cur.block).allowCrossTypeCombo
                    || ((CombinedRegenProjector) o.block).allowCrossTypeCombo)) {
                if (b != this)
                    comboGroup.add((CombinedRegenProjectorBuild) b);
            }
        ...
        public void splitAssets(Seq<CombinedRegenProjectorBuild> oldGroup, Seq<CombinedRegenProjectorBuild> newGroup) {
            ...
            CombinedRegenProjectorBuild newLeader = null;
            for (CombinedRegenProjectorBuild b : newGroup)
            ...
            CombinedRegenProjectorBuild oldLeader = newLeader;
        ...
        // 地图区里只写"原版那一份字节"（RegenProjectorBuild 就是 Building），
