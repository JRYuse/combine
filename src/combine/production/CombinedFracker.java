...
public class CombinedFracker extends Fracker {
    ...
    public class CombinedFrackerBuild extends FrackerBuild implements combine.saves.ComboSaved {
        ...
        // -------------------- 序列化 --------------------
        // 地图区里只写"原版那一份字节"（FrackerBuild/SolidPumpBuild/PumpBuild 都是 Building），
