...
public class CombinedReconstructor extends Reconstructor implements IUnitCombo.IUnitComboBlock {
    ...
    public class CombinedReconstructorBuild extends ReconstructorBuild implements IUnitCombo, combine.saves.ComboSaved {
        ...
        // -------------------- 序列化 --------------------
        // 地图区里只写"原版升级厂那一份字节"（super.write 就是 ReconstructorBuild 自己的布局），
